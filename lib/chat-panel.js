  ...
  setupCommands() {
    ...
    this.disposables.add(
      atom.commands.add(this.promptEditor.element, {
        ...
        "claude-chat:clear": () => this.handleClear(),
        ...
        <div className="claude-chat-input">
          ...
          <div className="claude-chat-toolbar">
            <span className="token-usage">
              {this.tokenUsage.input + this.tokenUsage.output} tokens
            </span>
            {this.attachContext ? (
              <span
                ref="attachIndicator"
            ...
            <div className="toolbar-actions">
              <div className="btn-group thinking-btn">
                <button
                  ref="thinkingBtn"
              ...
              {this.isLoading ? (
                <button
                  ref="stopBtn"
                  className="btn btn-error send-btn icon icon-primitive-square"
                  on={{ click: () => this.handleStop() }}
                />
              ) : (
                <button
                  ref="sendBtn"
                  className="btn btn-primary send-btn icon icon-triangle-right keystroke"
